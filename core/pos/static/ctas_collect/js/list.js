            ...
            tblPaymentsCtasCollect = $('#tblPayments').DataTable({
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        class: 'text-center',
                        render: function (data, type, row) {
                            var buttons = '<a rel="delete" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-times"></i></a> ';
                            buttons += '<a href="' + pathname + 'print/' + row.id + '/" target="_blank" class="btn btn-success btn-xs btn-flat"><i class="fa-solid fa-print"></i></a>'
                            return buttons;
                        }
                    }
                ],
