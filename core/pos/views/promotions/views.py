...
class PromotionsListView(GroupPermissionMixin, FormView):
    ...
    def get_queryset(self):
        ...
        promotions = Promotions.objects.filter(end_date__lte=date_now, state=True)
        if promotions.exists():
            promotions.update(state=False)
...
class PromotionsCreateView(GroupPermissionMixin, CreateView):
    model = Promotions
...
class PromotionsUpdateView(GroupPermissionMixin, UpdateView):
    model = Promotions
    template_name = 'promotions/create.html'
    form_class = PromotionsForm
    success_url = reverse_lazy('promotions_list')
...
class PromotionsDeleteView(GroupPermissionMixin, DeleteView):
    model = Promotions
