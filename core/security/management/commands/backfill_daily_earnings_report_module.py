...
MODULE_URL = '/reports/earnings/daily/'
MODULE_NAME = 'Ganancia Diaria'
MODULE_ICON = 'fas fa-coins'
MODULE_DESCRIPTION = 'Permite ver la utilidad real por día (precio facturado según cliente vs. costo del producto)'
MODULE_TYPE_NAME = 'Reportes'


class Command(BaseCommand):
    help = (
        "Agrega el módulo 'Ganancia Diaria' (y su acceso para el grupo Administrador) "
