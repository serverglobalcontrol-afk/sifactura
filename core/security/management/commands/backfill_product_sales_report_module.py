...
MODULE_URL = '/reports/product/sales/'
MODULE_NAME = 'Ventas por Producto'
MODULE_ICON = 'fas fa-search-dollar'
MODULE_DESCRIPTION = 'Permite saber a quién se le vendió un producto (cliente, comprobante, fecha), o buscar por número de comprobante'
MODULE_TYPE_NAME = 'Reportes'


class Command(BaseCommand):
    help = (
        "Agrega el módulo 'Ventas por Producto' (y su acceso para el grupo Administrador) "
        "a las compañías que ya existían antes de que se creara este reporte, ya que "
        "create_base_modules() solo se ejecuta al crear una compañía nueva. Es seguro "
        "volver a ejecutarlo: si el módulo ya existe en una compañía, se omite."
    )
